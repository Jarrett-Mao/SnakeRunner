...
//             PartsAmountTextMesh.transform.parent.position = newPart.position + new Vector3 (0, 0.3f, 0); //fixed
...
//         // }
//         else {
//             if (BodyParts.Count > 0) // Check if there are elements in the list
//             {
//                 newPart = Instantiate(BodyPrefab, BodyParts[BodyParts.Count - 1].position, BodyParts[BodyParts.Count - 1].rotation).transform;
//                 newPart.SetParent(transform);
//                 BodyParts.Add(newPart);
//             }
//             else
